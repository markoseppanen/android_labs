              ...
              Column(
                  ...
                  modifier =
                      Modifier.background(Purple40)
                          ...
                          .padding(16.dp)) {
                    if (darkness) {
                      Text(text = stringResource(R.string.goodbye_darkness), color = PurpleGrey80)
                    } else {
                      Text(text = stringResource(R.string.hello_world), color = PurpleGrey80)
                    }
                    Box(
                        contentAlignment = Alignment.Center,
                        modifier = Modifier.background(Purple80).size(200.dp)) {
                          Text("2", color = Pink40)
                        }
                  }
              Button(
                  ...
                  colors =
                      ButtonDefaults.buttonColors(
                          containerColor = Purple40, contentColor = PurpleGrey80)) {
